            ...
            <div>
                <div className="flex lg:hidden flex-col">
                    <div className="flex items-center justify-center flex-col rounded-t-[2.778vw] drop-shadow-xl">
                        ...
                        <Link className="w-full h-[19.444vw] font-redditsanssemibold text-center text-black text-[3.889vw] border-b-[0.278vw] border-[#1B1B1B] border-opacity-10 self-center flex items-center justify-center" href="/"><p className=" items-center justify-center">Kepengurusan</p></Link>
                        <Link className="w-full h-[19.444vw] font-redditsanssemibold text-center text-black text-[3.889vw] border-b-[0.278vw] border-[#1B1B1B] border-opacity-10 self-center flex items-center justify-center" href="/"><p className=" items-center justify-center">BSO</p></Link>
                        <Link className="w-full h-[19.444vw] font-redditsanssemibold text-center text-black text-[3.889vw] border-b-[0.278vw] border-[#1B1B1B] border-opacity-10 self-center flex items-center justify-center" href="/"><p className=" items-center justify-center">TETI Champion</p></Link>
                        <Link className="w-full h-[19.444vw] font-redditsanssemibold text-center text-black text-[3.889vw] border-b-[0.278vw] border-[#1B1B1B] border-opacity-10 self-center flex items-center justify-center" href="/"><p className=" items-center justify-center">Artikel</p></Link>
                        <Link className="w-full h-[19.444vw] font-redditsanssemibold text-center text-black text-[3.889vw] border-b-[0.278vw] border-[#1B1B1B] border-opacity-10 self-center flex items-center justify-center" href="/"><p className=" items-center justify-center">Kesekretariatan Online</p></Link>
                    </div>
