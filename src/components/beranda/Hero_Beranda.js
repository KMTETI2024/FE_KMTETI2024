    ...
    return (
        <div className="h-[200vw] lg:h-[56.25vw] flex flex-col lg:flex-row justify-center items-center bg-white relative">
            ...
            <div className="lg:w-[30%] lg:mr-[7.24vw] gap-y-0 lg:gap-y-[2.708vw] flex flex-col p-[6.944vw] lg:p-0">
                <h1 className="font-redditsanssemibold text-[10.556vw] lg:hidden leading-none text-black">KMTETI</h1>
                <h2 className="font-archivolight text-black text-[3.889vw] lg:hidden">merupakan singkatan dari Keluarga Mahasiswa Teknik Elektro dan Teknologi Informasi.</h2>
                <h1 className="text-[1.823vw] text-black hidden lg:block"><span className="font-archivo">KMTETI merupakan singkatan dari </span><span className=" font-archivosemibold">Keluarga Mahasiswa Teknik Elektro dan Teknologi Informasi.</span></h1>
                <h2 className="lg:text-[1.302vw] text-[3.333vw] text-black mt-[10vw] lg:mt-0"><span className="lg:font-archivothin font-archivolight">KMTETI adalah organisasi resmi yang ada di Departemen Teknik Elektro dan Teknologi Informasi (DTETI). Salah satu semboyan yang dimiliki KMTETI adalah </span><span className=" font-archivosemibolditalic">Profesionalisme Berbasis Kekeluargaan.</span></h2>
            </div>
