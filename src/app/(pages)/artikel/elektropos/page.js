    ...
    return (
        <div className='px-[8.611vw] py-[28.778vw] lg:px-[16.146vw] lg:py-[11.094vw] '>
            <div className='flex-col gap-y-[2vw] lg:flex hidden'>
                <h1 className='font-redditsanssemibold text-[2.344vw] text-black' data-aos="fade-up"
            data-aos-duration={aosDuration}
            data-aos-delay={getDelay({turn: 1})}>Elektropos</h1>
                <hr className="z-[9] lg:w-full w-[77.222vw] h-[0.2vw] bg-black mb-[1vw]" data-aos="fade-up"
            data-aos-duration={aosDuration}
